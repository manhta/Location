            ...
            for i in range(len(boxes)):
                ...
                if class_dict[class_id] == "person":
                    ...
                    cv.putText(frame, f'Dis: {dis} m', (10,55), 
                               cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
                    cv.putText(frame, f'Dis (Z): {dis2} m', (10,135), 
                               cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
                    cv.putText(frame, f'GPS [1]: ({gps2[0]:.6f}, {gps2[1]:.6f})', (10,155), 
                               cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
                    cv.putText(frame, f'GPS [2]: ({gps_test2[0]:.6f}, {gps_test2[1]:.6f})', (10,175), 
                               cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
                    cv.putText(frame, f'GPS [3]: ({koreaGPS2[0]:.6f}, {koreaGPS2[1]:.6f})', (10,195), 
                               cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
